...
def generate_launch_description() -> LaunchDescription:
    ...
    # Injected from the environment. No package-internal default:
    # an empty value makes the node raise FileNotFoundError instead
    # of silently pointing at a path that does not exist.
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            description='Absolute path to road_best.pt. Defaults to $KMU_MODEL_PATH.'),
        DeclareLaunchArgument(
